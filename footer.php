        ...
        <div class="container mt-4">
            ...
            <div class="row mt-1 text-center">
                ...
                <p> <?php _e('Copyright ©','behealthy'); echo date('Y'); ?> <a href="<?php echo site_url(); ?>" class="text-decoration-none link-danger"><?php bloginfo("name"); ?></a> <?php _e('|| All
                    rights reserved','behealthy');?><br> <a href="#" class="text-decoration-none link-danger" target="_blank"><?php _e('BeHealthy-Theme ','behealthy'); ?></a><?php _e('by','behealthy'); ?><a href="#" class="text-decoration-none link-danger" target="_blank"><?php _e(' Raiyan Noory Rady','behealthy'); ?></a>
                </p>
